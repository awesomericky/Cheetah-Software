#ifndef FSM_STATE_ILRLJOINTPD_H
#define FSM_STATE_ILRLJOINTPD_H
...
#define ILRLOBSDIM 147  // TODO

/**
 *
 */
template <typename T>
class FSM_State_ILRLJointPD : public FSM_State<T> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  FSM_State_ILRLJointPD(ControlFSMData<T>* _controlFSMData);
  ...
  virtual const Eigen::Matrix<float, ILRLOBSDIM, 1>& getObservation();
 ...
 protected:
  ...
  rai::FuncApprox::MLP_fullyconnected<float, ILRLOBSDIM, 12, rai::FuncApprox::ActivationType::leakyrelu> policy;
